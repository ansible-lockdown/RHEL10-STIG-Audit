...
This repository is set of configuration files and directories to run the audit of the relevant benchmark of RHEL 10 servers
...
- e.g. v1.1.0 will pull in branch benchmark-v1.1.0
